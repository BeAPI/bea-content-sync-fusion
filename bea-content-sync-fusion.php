...
// Plugin constants
define( 'BEA_CSF_VERSION', '1.0.1' );
define( 'BEA_CSF_OPTION', 'bea-content-sync-fusion' );
define( 'BEA_CSF_LOCALE', 'bea-content-sync-fusion' );

define( 'BEA_CSF_URL', plugins_url( '', __FILE__ ) );
define( 'BEA_CSF_DIR', dirname( __FILE__ ) );
...
function init_bea_content_sync_fusion() {
	// Load translations
	load_plugin_textdomain ( BEA_CSF_LOCALE, false, basename(rtrim(dirname(__FILE__), '/')) . '/languages' );
