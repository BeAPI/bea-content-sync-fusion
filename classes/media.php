...
class BEA_CSF_Media {
	...
	/**
	 * Allow only local delelation, not delete emitter file
	 *
	 * @param string $file
	 *
	 * @return string|false
	...
	public static function wp_delete_file( $file ) {
		$current_site_upload_dir = wp_upload_dir();

		// Not the same base dir folder ? Cancel file delation...
		if ( strpos( $file, $current_site_upload_dir['basedir'] ) === false ) {
			return false;
		}
