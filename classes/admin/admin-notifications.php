...
class BEA_CSF_Admin_Notifications {
	...
	public static function admin_enqueue_scripts( $hook_suffix = '' ) {
		if ( isset( $hook_suffix ) && $hook_suffix == 'settings_page_bea-csfc-notifications' ) {
			...
			wp_localize_script('bea-csf-admin-notifications', 'beaCsfAdminNotifications', array('selectableHeader' => __('Selectable users', 'bea-content-sync-fusion'), 'selectionHeader' => __('Selection users', 'bea-content-sync-fusion')) );
