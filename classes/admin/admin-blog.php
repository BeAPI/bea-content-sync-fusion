...
class BEA_CSF_Admin_Blog {
	...
	public function __construct() {
		...
		add_action( 'network_sites_updated_message_resync_bea_csf_content', [ __CLASS__, 'network_sites_updated_message' ] );
		add_action( 'network_sites_updated_message_sync_bea_csf_content', [ __CLASS__, 'network_sites_updated_message' ] );
	}
